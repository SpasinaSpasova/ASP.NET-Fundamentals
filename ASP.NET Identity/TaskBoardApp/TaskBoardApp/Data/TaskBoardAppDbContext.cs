...
namespace TaskBoardApp.Data
{
    public class TaskBoardAppDbContext : IdentityDbContext<User>
    {
        ...
        {
            builder.Entity<Task>().HasOne(t => t.Board).WithMany(b => b.Tasks).HasForeignKey(t => t.BoardId).OnDelete(DeleteBehavior.Restrict);
            ...
            builder.Entity<Task>().HasData(
                ...
                new Task()
                {
                    ...
                    Description = "Learn using EFC and MSSQL Management Studio",
